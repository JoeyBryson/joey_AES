...
file ↔ byte_arr ↔ state_arr(plain) ↔ state_arr(encrypted) ↔ .jwy file  

byte_arr is an array of byte_t's, state_arr is an array of state_t's. The encryption/decryption step is applied in place on the state_t states individually. These datatypes are declared.
