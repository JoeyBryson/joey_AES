...
void test_write_and_read_key_file128(void)
{
    ...
    TEST_ASSERT_EQUAL_INT32_MESSAGE(memcmp(key.words, key2.words, key.num_key_words*sizeof(word_t)), 0, "Key read/write unsuccessfull");
    TEST_ASSERT_EQUAL_INT32_MESSAGE(key.num_key_words, key2.num_key_words, "Key read/write unsuccessfull");
