...
//inverse of test used in 192 bit test in test_cipher.c
...
//test vectors is first line of plaintext on page 25 of the NIST Block Cipher Modes of Operation Electronic Codebook (ECB)
//inverse of test used in 256 bit test in test_cipher.c
//https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Standards-and-Guidelines/documents/examples/AES_Core_All.pdf
