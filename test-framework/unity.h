...
/* This macro does nothing, but it is useful for build tools (like Ceedling) to make use of this to
 * figure out which files should be linked to in order to perform a test. Use it like
 * TEST_FILE("sandwiches.c") */
#define TEST_FILE(a)
